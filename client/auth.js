...
const translations = {
  en: {
    ...
    registerSubtitle: 'Fill in your information to create a new user account.',
    ...
    registerAsideText: 'Register a user account to reserve seats and track reservation activity.',
    backHome: 'Choose Seat',
